...
<style>
  ...
  small.text-danger{color:#EF4444;font-size:12px;}
</style>
  ...
  <div class="px-24 py-24 card-soft category-create">
    <form id="categoryform" action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div>
          ...
          <div class="grid-1">
            ...
            <div class="form-row">
              ...
              <small class="error-status text-danger"></small>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="grid-1">
            <div class="form-row">
              ...
              <small class="error-category_description text-danger"></small>
            </div>
          </div>
        </div>
      ...
      <div class="gap-12 mt-24 d-flex align-items-center">
        <button type="submit" name="create_category" class="px-16 py-10 btn btn-ghost is-primary pill transition-03">Create Category</button>
        <button type="reset" class="px-16 py-10 btn btn-ghost pill transition-03">Cancel</button>
      </div>

      <div id="msg" class="mt-16"></div>
    </form>
  </div>
</div>
