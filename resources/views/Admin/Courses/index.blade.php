            ...
            <ul class="gap-12 nav nav-pills common-tab" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="gap-8 nav-link rounded-pill fw-medium text-14 flex-center active"
                        ...
                        Published ({{ $courses->where('status', 1)->count() }})
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="gap-8 nav-link rounded-pill fw-medium text-14 flex-center"
                        ...
                        Pending ({{ $courses->where('status', 0)->count() }})
                    </button>
                </li>
            </ul>
        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="p-16 course-card rounded-16 h-100 transition-03"
                                    ...
                                    <div class="overflow-hidden course-thumb rounded-12">
                                        @if($course->course_thumbnail && $course->course_thumbnail != "no found image")
                                            <img src="{{ asset('admin/course_thumbnail/' . $course->course_thumbnail) }}"
                                                alt="{{ $course->course_title }}" class="w-100 cover-img rounded-12"
                                    ...
                                    <div class="course-actions position-absolute top-12 right-12">
                                        <div class="dropdown">
                                            <button class="p-0 btn" type="button" data-bs-toggle="dropdown"
                                                style="background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.3); width: 32px; height: 32px; border-radius: 8px; margin-left: 12rem; margin-top: 1rem;">
                                ...
                                <div class="course-content">
                                    ...
                                    <h5 class="mb-12">
                                        <a href="#" class="fw-semibold text-16" style="color: white; text-decoration: none;">
                                            {{ $course->course_title }}
                                        </a>
                                    </h5>

                                    <p class="mb-16 text-14" style="color: rgba(255,255,255,0.7);">
                                    ...
                                    <div class="mb-0 course-stats d-flex align-items-center justify-content-between">
                                        <div class="gap-8 d-flex align-items-center">
                                            <div class="gap-6 d-flex align-items-center">
                                                ...
                                                <span class="text-12 fw-medium" style="color: rgba(255,255,255,0.8);">
                                                    videos {{ $course->course_video ? count(explode(',', $course->course_video)) : 0 }}
                                                </span>
                                            </div>
                                            <div class="gap-6 d-flex align-items-center">
                                                <i class="fas fa-clock text-12" style="color: rgba(255,255,255,0.7);"></i>
                                                <span class="text-12 fw-medium" style="color: rgba(255,255,255,0.8);">
                                                    {{ $course->course_total_hours }} total Hours
                                                </span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="tab-pane fade" id="pills-pending" role="tabpanel" aria-labelledby="pills-pending-tab">
                <div class="row gy-4">
                    @foreach ($courses->where('status', 0) as $course)
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <!-- Duplicate course card HTML here -->
                            <div class="p-16 course-card rounded-16 h-100 transition-03"
                                style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);">
                                    ...
                                    <div class="course-actions position-absolute top-12 right-12">
                                        <div class="dropdown">
                                          ...
                                          <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="fas fa-eye me-2"></i>View</a>
                                                    </li>
                                                    <li>
                                                        <form action="{{ route('courses.destroy', $course->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this course?');">
                                                            @csrf
