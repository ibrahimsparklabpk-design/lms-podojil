...
<div class="px-24 py-24">
 ...
 <form id="courseeditform" action="{{ route('courses.update' , $courses->id) }}" method="POST" enctype="multipart/form-data" class="px-24 py-24 card-soft course-create">
  @csrf
  @method('PUT')
    ...
    <div>
      ...
      <div class="grid-1">
        <div class="form-row">
          ...
          <input name="course_title" type="text" class="control" placeholder="Enter course title" value={{ $courses->course_title }}>
        ...
        <div class="form-row">
          ...
          <select name="course_type" class="control">
            ...
            <option value="Online Course" {{ $courses->course_type == "Online Course" ? "selected" : "" }}>Online Course</option>
            <option value="Onsite Course" {{ $courses->course_type == "Onsite Course" ? "selected" : "" }}>Onsite Course</option>
          </select>
        ...
        <div class="form-row">
          <label>Price ($)</label>
          <input name="course_price" type="number" step="0.01" min="0" class="control" placeholder="0.00" value={{ $courses->course_price }}>
        ...
        <div class="form-row">
          ...
          <select name="course_level" class="control">
            ...
            <option value="Beginner" {{ $courses->course_level == "Beginner" ? "selected" : null }}>Beginner</option>
            <option value="Intermediate" {{ $courses->course_level == "Intermediate" ? "selected" : null }}>Intermediate</option>
            <option value="Advanced" {{ $courses->course_level == "Advanced" ? "selected" : null }}>Advanced</option>
          </select>
        ...
        <div class="form-row">
          ...
          <textarea name="course_description" class="control textarea" placeholder="Describe your course in detail...">{{ $courses->course_description }}</textarea>
    ...
    <div>
      ...
      <div class="grid-1">
        <div class="form-row">
          ...
          <input name="course_duration_weeks" type="number" min="0" class="control" placeholder="e.g., 8" value="{{ $courses->course_duration_weeks }}">
          <small class="text-danger error-course_duration_weeks"></small>
        </div>

        <div class="form-row">
          <label>Total Hours</label>
          <input name="course_total_hours" type="number" class="control" placeholder="e.g., 40" value="{{ $courses->course_total_hours }}">
          <small class="text-danger error-course_total_hours"></small>
        </div>

        <div class="form-row">
          <label>Language</label>
          <input name="course_language" type="text" class="control" placeholder="English" value="{{ $courses->course_language }}">
